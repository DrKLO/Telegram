...
public sealed class TlGen_ChatFull : TlGen_Object {
  public data class TL_chatFull(
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      multiflags_17?.requests_pending?.let { stream.writeInt32(it) }
      multiflags_17?.recent_requesters?.let { TlGen_Vector.serializeLong(stream, it) }
  ...
  public data class TL_channelFull(
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      multiflags_2?.kicked_count?.let { stream.writeInt32(it) }
      multiflags_2?.banned_count?.let { stream.writeInt32(it) }
      ...
      multiflags_4?.migrated_from_chat_id?.let { stream.writeInt64(it) }
      multiflags_4?.migrated_from_max_id?.let { stream.writeInt32(it) }
      pinned_msg_id?.let { stream.writeInt32(it) }
      ...
      groupcall_default_join_as?.serializeToStream(stream)
      theme_emoticon?.let { stream.writeString(it) }
      multiflags_28?.requests_pending?.let { stream.writeInt32(it) }
      multiflags_28?.recent_requesters?.let { TlGen_Vector.serializeLong(stream, it) }
  ...
  public data class TL_channelFull_layer48(
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      exported_invite.serializeToStream(stream)
      TlGen_Vector.serialize(stream, bot_info)
      multiflags_4?.migrated_from_chat_id?.let { stream.writeInt32(it) }
      multiflags_4?.migrated_from_max_id?.let { stream.writeInt32(it) }
    }
  ...
  public data class TL_channelFull_layer101(
    ...
    public override fun serializeToStream(stream: OutputSerializedData) {
      ...
      multiflags_2?.kicked_count?.let { stream.writeInt32(it) }
      multiflags_2?.banned_count?.let { stream.writeInt32(it) }
      multiflags_13?.online_count?.let { stream.writeInt32(it) }
      stream.writeInt32(read_inbox_max_id)
      stream.writeInt32(read_outbox_max_id)
      stream.writeInt32(unread_count)
      chat_photo.serializeToStream(stream)
      ...
      available_min_id?.let { stream.writeInt32(it) }
      folder_id?.let { stream.writeInt32(it) }
      multiflags_13?.linked_chat_id?.let { stream.writeInt32(it) }
      stream.writeInt32(pts)
    }
