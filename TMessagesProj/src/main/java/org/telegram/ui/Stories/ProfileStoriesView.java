...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        float offsetX = (avatarContainer.getWidth() * (scaleX - 1)) / 2f;
        float offsetY = (avatarContainer.getHeight() * (scaleY - 1)) / 2f;

        float ax = avatarContainer.getX() - offsetX + insetMain * scaleX;
        float ay = avatarContainer.getY() - offsetY + insetMain * scaleY;
