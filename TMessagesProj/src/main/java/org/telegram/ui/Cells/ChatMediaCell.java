        ...
        if (buttonState == 0) {
            if (currentMessageObject.type == 1) {
                if (currentMessageObject.imagePreview != null) {
                    ...
                    photoImage.setImage(currentPhotoObject.getLocation(), currentPhotoFilter, currentMessageObject.isOut() ? placeholderOutDrawable : placeholderInDrawable, currentPhotoObject.getSize());
                }
            } else if (currentMessageObject.type == 8) {
                    ...
                    if (currentPhotoObject.image != null) {
                        ...
                        if (photoExist || downloadPhotos) {
                            if (messageObject.imagePreview != null) {
                                ...
                                photoImage.setImage(currentPhotoObject.getLocation(), currentPhotoFilter, messageObject.isOut() ? placeholderOutDrawable : placeholderInDrawable, currentPhotoObject.getSize());
                            }
                        } else {
                            if (messageObject.imagePreview != null) {
