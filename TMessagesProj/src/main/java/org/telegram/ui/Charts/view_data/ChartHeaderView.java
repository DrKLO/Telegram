...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        title.setTypeface(LocaleController.getInstance().setMediumFont());
        ...
        dates.setTypeface(LocaleController.getInstance().setMediumFont());
        ...
        datesTmp.setTypeface(LocaleController.getInstance().setMediumFont());
