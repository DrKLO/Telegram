...
public class PollVotesAlert extends BottomSheet {
    ...
    public class SectionCell extends FrameLayout {
        ...
        public void setText(String left, int percent, int votesCount, int collapsed) {
            ...
            builder.setSpan(new TypefaceSpan(ThePenisMightierThanTheSword.getFont(MessagesController.getGlobalTelegraherUICustomFont("fonts/rmedium.ttf", "rmedium"))), 3, 3 + p.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
