...
public class TranslateButton extends FrameLayout {
    ...
    public void updateColors() {
        ...
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawableI(dp(15), 0, Theme.getColor(Theme.key_chat_addContact, resourcesProvider) & 0x19ffffff, dp(3), dp(3), dp(3), dp(3)));
