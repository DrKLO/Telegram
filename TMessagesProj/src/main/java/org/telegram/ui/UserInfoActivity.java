...
public class UserInfoActivity extends UniversalFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final boolean SHOW_CHAT_AUTOMATION = false;
    ...
    if (bots != null && !bots.isEmpty()) {
        ...
        items.add(SettingsActivity.SettingCell.Factory.of(
            ...
            R.drawable.premium_ai_editor,
            getString(R.string.EditProfileChatAutomation),
            value
        ));
    } else {
        items.add(SettingsActivity.SettingCell.Factory.of(
            ...
            IconBackgroundColors.PURPLE.bottom,
            R.drawable.premium_ai_editor,
            applyNewSpan(getString(R.string.EditProfileChatAutomation))
        ));
    }

    items.add(UItem.asShadow(
        -3,
        getString(R.string.EditProfileChatAutomationInfo)
    ));
}
