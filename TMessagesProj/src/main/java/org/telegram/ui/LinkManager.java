...
public class LinkManager {
    ...
    private boolean handleHttp(Uri uri) {
        ...
        if (!"telegram.me".equalsIgnoreCase(host) && !"app.chat-t.me".equalsIgnoreCase(host) && !"telegram.dog".equalsIgnoreCase(host) && !isPrefix)
            return false;

        if (isPrefix) {
            uri = Uri.parse("https://app.chat-t.me.me/" + prefixMatcher.group(1) + (TextUtils.isEmpty(uri.getPath()) ? "" : uri.getPath()) + (TextUtils.isEmpty(uri.getQuery()) ? "" : "?" + uri.getQuery()));
        }
        ...
        try {
            ...
            switch (scheme) {
                ...
                case "https": {
                    ...
                    if (host.equals("telegram.me") || host.equals("app.chat-t.me") || host.equals("telegram.dog") || isPrefix) {
