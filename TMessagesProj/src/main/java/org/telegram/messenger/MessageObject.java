...
public class MessageObject {
    ...
    private void generateLayout(TLRPC.User fromUser) {
        ...
        //
        //TLRPC.MessageEntity ent = new TLRPC.TL_messageEntityCode();//TL_messageEntityBold();
        //ent.offset = 0;
        //ent.length = messageText.length();
        //messageOwner.entities.add(ent);
        //
        ...
        if (messageText instanceof Spannable) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                //Log.e("MessageObject","entity " + entity.toString() + " offset " + entity.offset + " length " + entity.length + " type " + type);
                if (entity instanceof TLRPC.TL_messageEntityBold) {
                    //Log.e("MessageObject","TL_messageEntityBold offset " + entity.offset + " length " + entity.length);
                    ...
                    if (entity instanceof TLRPC.TL_messageEntityBotCommand) {
                        ...
                        if (!url.toLowerCase().startsWith("http")) {
                            ...
                            //Log.e("MessageObject","url " + url + " offset " + entity.offset + " length " + entity.length);
