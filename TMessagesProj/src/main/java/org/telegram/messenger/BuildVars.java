...
public class BuildVars {
    ...
    public static int APP_ID = 22497483;
    public static String APP_HASH = "93df1ea05aed23c5b644fa7229fdfb75";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=za.co.jay.code";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "za.co.jay.code".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return true;
    }
