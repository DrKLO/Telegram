...
public class BuildVars {
    ...
    // UZGRAM production MTProto credentials (my.telegram.org).
    public static int APP_ID = 33017664;
    public static String APP_HASH = "a5e889a7e48ed91f38d068f7878e6126";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=uz.uzgram.messenger";
