...
public:
    ...
    void setProxySettings(std::string address, uint16_t port, std::string username, std::string password, std::string secret, int32_t tlsFingerprint);
    ...
    int64_t checkProxy(std::string address, uint16_t port, std::string username, std::string password, std::string secret, int32_t tlsFingerprint, onRequestTimeFunc requestTimeFunc, jobject ptr1);
...
private:
    ...
    int32_t proxyTlsFingerprint = MTProxyTlsFingerprintDefault;
