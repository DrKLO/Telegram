...
absl::optional<uint32_t> H265PpsParser::ParsePpsIdFromSliceSegmentLayerRbsp(
  ...
  RETURN_EMPTY_ON_FAIL(
      slice_reader.ReadBits(1, first_slice_segment_in_pic_flag));
...
absl::optional<H265PpsParser::PpsState> H265PpsParser::ParseInternal(
  ...
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps.dependent_slice_segments_enabled_flag));
  // output_flag_present_flag: u(1)
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps.output_flag_present_flag));
  // num_extra_slice_header_bits: u(3)
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(3, pps.num_extra_slice_header_bits));
  // sign_data_hiding_enabled_flag: u(1)
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, bits_tmp));
  // cabac_init_present_flag: u(1)
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps.cabac_init_present_flag));
  ...
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, cu_qp_delta_enabled_flag));
  ...
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps.weighted_pred_flag));
  // weighted_bipred_flag: u(1)
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps.weighted_bipred_flag));
  // transquant_bypass_enabled_flag: u(1)
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, bits_tmp));
  // tiles_enabled_flag: u(1)
  uint32_t tiles_enabled_flag = 0;
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, tiles_enabled_flag));
  ...
  if (tiles_enabled_flag) {
    ...
    RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, uniform_spacing_flag));
  ...
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, deblocking_filter_control_present_flag));
  if (deblocking_filter_control_present_flag) {
    // deblocking_filter_override_enabled_flag: u(1)
    RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, bits_tmp));
    // pps_deblocking_filter_disabled_flag: u(1)
    uint32_t pps_deblocking_filter_disabled_flag = 0;
    RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps_deblocking_filter_disabled_flag));
  ...
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps_scaling_list_data_present_flag));
  ...
  RETURN_EMPTY_ON_FAIL(bit_buffer->ReadBits(1, pps.lists_modification_present_flag));
