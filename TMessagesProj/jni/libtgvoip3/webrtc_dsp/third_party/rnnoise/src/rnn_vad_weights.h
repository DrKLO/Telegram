...
const size_t kHiddenLayerWeights = 3 * kInputLayerOutputSize * kHiddenLayerOutputSize;
...
const size_t kOutputLayerWeights = kHiddenLayerOutputSize * kOutputLayerOutputSize;
