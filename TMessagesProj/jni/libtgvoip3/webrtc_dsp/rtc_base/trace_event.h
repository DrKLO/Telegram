...
#define INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO(category) \
    INTERNAL_TRACE_EVENT_INFO_TYPE INTERNAL_TRACE_EVENT_UID(catstatic) = TRACE_EVENT_API_GET_CATEGORY_ENABLED(category);
...
namespace trace_event_internal
{
    ...
    public:
        ...
        {
        public:
            explicit ForceMangle(unsigned long long id)
                : data_(id)
            {
            }
            explicit ForceMangle(unsigned long id)
                : data_(id)
            {
            }
        ...
        explicit TraceID(ForceMangle id, unsigned char* flags)
            : data_(id.data())
        {
            *flags |= TRACE_EVENT_FLAG_MANGLE_ID;
        }
