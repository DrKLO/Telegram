...
namespace safe_minmax_impl
{
    ...
    struct TypeOr
    {
        ...
        static_assert(IsIntlike<type>::value == IsIntlike<B>::value && std::is_floating_point<type>::value == std::is_floating_point<B>::value,
...
namespace safe_minmax_impl
{
    ...
    private:
        ...
        {
        private:
            static constexpr bool not_too_large = sizeof(A) <= sizeof(L) || sizeof(A) <= sizeof(H) || sizeof(A) <= sizeof(T);
